...
import hibernate.util.CompositeQuery.HibernateUtil_CompositeQuery_rest_ifo;
...
public class RestIfoService {
	...
	public void deleteRestIfo(Integer restLoc) {
		if (repository.existsById(restLoc))
			repository.deleteByRestLoc(restLoc);
...
//		return optional.get();
	...
	public List<RestIfoVO> getAll(Map<String, String[]> map) {
		return HibernateUtil_CompositeQuery_rest_ifo.getAllC(map, sessionFactory.openSession());
	}
